            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header text-center">
                        <h4>Edición de un juego</h4>
                    </div>

                    <div class="card-body text-center">
                        <form action="{{ route('admin.boardgames.update', $boardgame->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <div class="input-wrap">
                                        ...
                                        <label for="photo">Foto del juego</label>
                                    </div>
                                </div>
                            ...
                            <div class="text-center" style="margin-top: 15px">
                                <button type="submit" class="btn btn-dark btn-sm">Actualizar juego</button>
                            </div>
                        </form>
                    </div>
                </div>
